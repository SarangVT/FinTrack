...
const NavBar = (props) => {
    ...
    return (
        <>
        {isMobile ? (
        <nav className="bg-gradient-to-r from-[#43b0f1] to-[#057dcd] text-white font-bold p-3 text-[18px] px-6 flex items-center justify-between">
        ...
        {menuOpen && (
            <div className="absolute top-14 left-0 w-full bg-gradient-to-r from-[#43b0f1] to-[#057dcd] shadow-md opacity-90 z-10">
    ...
    //Desktop Starts
        ...
        <div className="flex flex-row gap-12 bg-gradient-to-r from-[#43b0f1] to-[#057dcd] text-white font-bold p-3 pl-6 items-center">
